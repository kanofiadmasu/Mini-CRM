...
This app is a CRUD app, that has CRUD operations for each objects (Clients, Projects, Invoices) in the app. The main fucntionality is:
...
When running on the terminal, there will be an output option to which object to manage, either Clients, Projects, or, Invoices. After selecting one you can do full CRUD opretions on them. 
